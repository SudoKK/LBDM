const DIALOG_DATA = {
    ...
    'cake': { icon: '🍰', title: "CAKE & CELEBRATIONS", text: "We'll wrap up the day with cake! 🎂 Note: A small contribution will be required. The exact amount will be communicated once we get the full guest list." },
